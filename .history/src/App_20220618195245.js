...
import './App.css';
import { RegDesc, RegInput, RegWrapper, UiWindow, UiWrapper, SettingsWrapper } from './Components/Components.elements';

function OpChange(){
  return(
    <>
    <input type="checkbox" label={"xdddd"} defaultChecked />
    <input type="checkbox"/>
    </>
    )
  }
