...
function OpChange(){
  return(
    ...
    <Labels>
      <CheckWrapper>
        MOV
        <OpBox type="checkbox"  checked={movChecked} onChange={(mov) => HandleCheck(mov)} id="MOV" name="MOV"/>
      </CheckWrapper>
      <CheckWrapper>
        XCHG
        <OpBox type="checkbox" checked={xchgChecked} onChange={(xchg) => HandleCheck(xchg)} id="XCHG" name="XCHG"/>
      </CheckWrapper>
    </Labels>
    </>
    )
