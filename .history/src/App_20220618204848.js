...
function OpChange(){
  return(
    ...
    <Labels>
      <CheckWrapper>
        MOV
        <OpBox type="checkbox"  checked={movChecked} id="MOV" onChange={(mov) => HandleCheck(props.id)} />
      </CheckWrapper>
      <CheckWrapper>
        XCHG
        <OpBox type="checkbox" checked={xchgChecked} onChange={(xchg) => HandleCheck(this.id)} id="XCHG" name="XCHG"/>
      </CheckWrapper>
    </Labels>
    </>
    )
