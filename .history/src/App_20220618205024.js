...
function OpChange(){
  return(
    ...
    <Labels>
      <CheckWrapper>
        MOV
        <OpBox type="checkbox"  checked={movChecked} onChange={() => this.HandleCheck(mov)} id="MOV"/>
      </CheckWrapper>
      <CheckWrapper>
        XCHG
        <OpBox type="checkbox" checked={xchgChecked} onChange={() => this.HandleCheck(xchg)} id="XCHG" name="XCHG"/>
      </CheckWrapper>
    </Labels>
    </>
    )
