...
function OpChange(){
  return(
    <>
    <Labels>
      <CheckWrapper onClick={() => HandleCheck(mov)}>
        MOV
        <OpBox type="checkbox"  checked={movChecked}  id="MOV"/>
      </CheckWrapper>
      <CheckWrapper onChange={() => HandleCheck(xchg)}>
        XCHG
        <OpBox type="checkbox" checked={xchgChecked}  id="XCHG" name="XCHG"/>
      </CheckWrapper>
    </Labels>
    </>
    )
