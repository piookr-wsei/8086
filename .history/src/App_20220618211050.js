...
import './App.css';
import { RegDesc, RegInput, RegWrapper, UiWindow, UiWrapper, SettingsWrapper, Labels, CheckWrapper, OpBox, ParamWrapper } from './Components/Components.elements';
      ...
      <UiWindow>
        <UiWrapper>
          ...
          <SettingsWrapper>
              ...
              <OpChange/>
              <>
              <RegDesc textContent={"A"}/>  <RegInput maxLength={2}/>
              </>
          </SettingsWrapper>
