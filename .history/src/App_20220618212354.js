...
import './App.css';
import { RegDesc, RegInput, RegWrapper, UiWindow, UiWrapper, SettingsWrapper, Labels, CheckWrapper, OpBox, LineWrap, NumDesc } from './Components/Components.elements';
      ...
      <UiWindow>
        <UiWrapper>
          ...
          <SettingsWrapper>
              ...
              <LineWrap>
              <NumDesc textContent={"Value in decimal"}/>  <RegInput maxLength={2} style={{width:"20px"}}/>
              </LineWrap>
          </SettingsWrapper>
