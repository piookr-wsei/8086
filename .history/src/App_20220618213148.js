...
import './App.css';
import { RegDesc, RegInput, RegWrapper, UiWindow, UiWrapper, SettingsWrapper, Labels, CheckWrapper, OpBox, LineWrap, NumDesc, RegChWrapper } from './Components/Components.elements';
...
function OpChange(){
  return(
    ...
    <Labels>
      ...
      <CheckWrapper style={{position:"relative", left:"20px"}}>
        XCHG
