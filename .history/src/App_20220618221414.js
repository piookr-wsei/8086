      ...
      <UiWindow>
        <UiWrapper>
          <RegWrapper>
            ...
            <RegDesc textContent={"A"}/>  <RegInput maxLength={5} readOnly value={"0x255"}/> <RegInput maxLength={2} readOnly/>
            <RegDesc textContent={"B"}/>  <RegInput maxLength={2} readOnly/> <RegInput maxLength={2} readOnly/>
            <RegDesc textContent={"C"} />  <RegInput maxLength={2} readOnly/> <RegInput maxLength={2} readOnly/>
            <RegDesc textContent={"D"}/>  <RegInput maxLength={2} readOnly/> <RegInput maxLength={2} readOnly/>
          </RegWrapper>
