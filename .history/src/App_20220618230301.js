...
function OpChange(){
  ...
  const [text, setText]=useState({topText:"",botText:""});
      ...
      <UiWindow>
        <UiWrapper>
          ...
          <SettingsWrapper>
              ...
              <LineWrap>
              <NumDesc textContent={"Value in hex"}/>  <RegInput maxLength={3} style={{width:"40px"}} onChange={handleChange} value={text.topText}/>
              </LineWrap>
              <Run>RUN</Run>
          </SettingsWrapper>
