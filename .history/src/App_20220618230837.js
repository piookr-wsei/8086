      ...
      <UiWindow>
        <UiWrapper>
          ...
          <SettingsWrapper>
              ...
              <LineWrap>
              <NumDesc textContent={"Value in hex"}/>  <input type="text" id="field-1" className="field" name="topText" placeholder="Top text" onChange={handleChange} value={text.topText}></input>
              </LineWrap>
              <Run>RUN</Run>
          </SettingsWrapper>
