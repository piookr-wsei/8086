      ...
      <UiWindow>
        <UiWrapper>
          ...
          <SettingsWrapper>
              ...
              <LineWrap>
              <NumDesc textContent={"Value in hex"}/>  <RegInput type="text" id="field-1" className="field" name="topText" placeholder="Top text" onChange={handleChange}  maxLength={3} style={{width:"40px"}}  value={text.topText}/> 
