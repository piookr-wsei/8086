      ...
      <UiWindow>
        <UiWrapper>
          <RegWrapper>
            ...
            <RegDesc textContent={"A"}/>  <RegInput  readOnly value={regValues[0]}/> <RegInput  readOnlyvalue={regValues[1]}/>
            <RegDesc textContent={"B"}/>  <RegInput  readOnly  readOnlyvalue={regValues[2]}/> <RegInput  readOnly  readOnlyvalue={regValues[3]}/>
            <RegDesc textContent={"C"} />  <RegInput  readOnly  readOnlyvalue={regValues[4]}/> <RegInput  readOnly  readOnlyvalue={regValues[5]}/>
            <RegDesc textContent={"D"}/>  <RegInput  readOnly  readOnlyvalue={regValues[6]}/> <RegInput  readOnly  readOnlyvalue={regValues[7]}/>
          </RegWrapper>
