...
function Compile(){
  ...
  if(movChecked==true && checkCurrent==1 && text.topText!=""){
    ...
    if(checkedBoxes[0]){
      ...
      else if(text.topText.length<=4){tempArray[1]=text.topText[1]+text.topText[0]; tempArray[0]=text.topText.substring(2); setRegValues(tempArray); setCheckedBoxes(falseArray)}
    }
